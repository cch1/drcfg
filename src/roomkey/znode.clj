          ...
          (do
            ...
            (case event-type
              ...
              :NodeCreated (do (log/debugf "Node %s created" (str this))
                               ...
                               (if (zclient/connected? client)
                                 (do (doseq [[z c] @children] (watch z c) (create z)) ; watch must be in place before create
              ...
              :NodeChildrenChanged (do (if (zclient/connected? client)
